...
try:
    if st.button('Predict'):
        ...
        response_scoring = requests.post('https://private.eu-de.ml.cloud.ibm.com/ml/v4/deployments/7eda709e-df60-46d0-87c9-9bac54561274/predictions?version=2021-05-01',
